...
grant update on table saved_places to authenticated;
...
drop policy if exists "Users can update saves from their own lists" on saved_places;
create policy "Users can update saves from their own lists"
on saved_places
for update
to authenticated
using (
