...
with
  ...
  save_seed (list_key, place_key, user_id, status, rating) as (
    values
      ('list_my', 'wild-honey-mandarin-gallery-238897', '11111111-1111-4111-8111-111111111111'::uuid, 'tried', 4.2),
      ('list_ryan', 'wild-honey-mandarin-gallery-238897', '33333333-3333-4333-8333-333333333333'::uuid, 'tried', 4.2),
      ('list_isabella', 'matchaya-takashimaya-238872', '44444444-4444-4444-8444-444444444444'::uuid, 'favourite', 4.6),
      ('list_my', 'matchaya-takashimaya-238872', '11111111-1111-4111-8111-111111111111'::uuid, 'favourite', 4.6),
      ('list_annj', 'surrey-hills-grocer-313-238895', '22222222-2222-4222-8222-222222222222'::uuid, 'want_to_try', 4.0),
      ('list_josh', 'five-guys-plaza-singapura-238839', '55555555-5555-4555-8555-555555555555'::uuid, 'tried', 3.9),
      ('list_annj', 'bearded-bella-089668', '22222222-2222-4222-8222-222222222222'::uuid, 'favourite', 4.5),
      ('list_ryan', 'bearded-bella-089668', '33333333-3333-4333-8333-333333333333'::uuid, 'favourite', 4.5),
      ('list_my', 'ramen-keisuke-tonkotsu-king-078867', '11111111-1111-4111-8111-111111111111'::uuid, 'tried', 4.3),
      ('list_josh', 'ramen-keisuke-tonkotsu-king-078867', '55555555-5555-4555-8555-555555555555'::uuid, 'tried', 4.3),
      ('list_ryan', 'dumpling-darlings-amoy-069905', '33333333-3333-4333-8333-333333333333'::uuid, 'favourite', 4.4),
      ('list_my', 'dumpling-darlings-amoy-069905', '11111111-1111-4111-8111-111111111111'::uuid, 'favourite', 4.4),
      ('list_josh', 'tian-tian-hainanese-chicken-rice-069184', '55555555-5555-4555-8555-555555555555'::uuid, 'tried', 4.1),
      ('list_isabella', 'apiary-088844', '44444444-4444-4444-8444-444444444444'::uuid, 'favourite', 4.7),
      ('list_ryan', 'apiary-088844', '33333333-3333-4333-8333-333333333333'::uuid, 'favourite', 4.7),
      ('list_annj', 'brotherbird-coffeehouse-189868', '22222222-2222-4222-8222-222222222222'::uuid, 'favourite', 4.6),
      ('list_isabella', 'brotherbird-coffeehouse-189868', '44444444-4444-4444-8444-444444444444'::uuid, 'favourite', 4.6),
      ('list_josh', 'singapore-zam-zam-198675', '55555555-5555-4555-8555-555555555555'::uuid, 'tried', 4.2),
      ('list_my', 'singapore-zam-zam-198675', '11111111-1111-4111-8111-111111111111'::uuid, 'tried', 4.2),
      ('list_isabella', 'twenty-grammes-bugis-198721', '44444444-4444-4444-8444-444444444444'::uuid, 'want_to_try', 4.0),
      ('list_josh', 'tongue-tip-lanzhou-beef-noodles-chinatown-point-059413', '55555555-5555-4555-8555-555555555555'::uuid, 'tried', 4.0),
      ('list_isabella', 'mei-heong-yuen-dessert-058611', '44444444-4444-4444-8444-444444444444'::uuid, 'tried', 4.2),
      ('list_my', 'mei-heong-yuen-dessert-058611', '11111111-1111-4111-8111-111111111111'::uuid, 'tried', 4.2),
      ('list_annj', 'two-men-bagel-house-holland-village-277731', '22222222-2222-4222-8222-222222222222'::uuid, 'favourite', 4.5),
      ('list_josh', 'two-men-bagel-house-holland-village-277731', '55555555-5555-4555-8555-555555555555'::uuid, 'favourite', 4.5),
      ('list_isabella', 'project-acai-holland-village-277738', '44444444-4444-4444-8444-444444444444'::uuid, 'tried', 4.1),
      ('list_annj', 'keong-saik-bakery-chip-bee-278116', '22222222-2222-4222-8222-222222222222'::uuid, 'want_to_try', 4.0),
      ('list_ryan', 'obba-bbq-serangoon-garden-556691', '33333333-3333-4333-8333-333333333333'::uuid, 'tried', 4.2),
      ('list_josh', 'food-republic-nex-556083', '55555555-5555-4555-8555-555555555555'::uuid, 'tried', 3.8),
      ('list_my', 'food-republic-nex-556083', '11111111-1111-4111-8111-111111111111'::uuid, 'tried', 3.8),
      ('list_isabella', 'hatter-street-bakehouse-530212', '44444444-4444-4444-8444-444444444444'::uuid, 'favourite', 4.3),
      ('list_annj', 'hatter-street-bakehouse-530212', '22222222-2222-4222-8222-222222222222'::uuid, 'favourite', 4.3),
      ('list_josh', 'tamjai-samgor-tampines-mall-529510', '55555555-5555-4555-8555-555555555555'::uuid, 'tried', 4.0),
      ...
      ('list_annj', 'paris-baguette-tampines-mall-529510', '22222222-2222-4222-8222-222222222222'::uuid, 'tried', 3.7)
  )
